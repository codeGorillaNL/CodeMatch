...
class SignupwgController {
  ...
  nextPage(user) {
    ...
    if (this.selectedTab == 0 && !this.signupwgForm1.$valid) {
      return this.errorMessage;
      // this.errorMessage = '';
      // this.selectedTab = this.selectedTab + 1;
    }
    if (this.selectedTab == 1 && !this.signupwgForm2.$valid) {
      return this.errorMessage;
    }
    else {
      this.errorMessage = '';
...
angular.module('codeGorillaApp')
  .controller('SignupwgController', SignupwgController);
